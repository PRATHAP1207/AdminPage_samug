...
import { defaultReportArray } from '../../../constant/Common'
                    ...
                    <div className="breadcrumb">
                        <Breadcrumb
                            routeSegments={[
                                { name: 'Home', path: '/' },
                                {
                                    name: <IntlMessages id="title.payout" />,
                                },
                            ]}
                        />
                    </div>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs>
                                ...
                                >
                                    ...
                                    <Select
                                        className="selectCustom"
                                        options={defaultReportArray}
                                        value={defaultReportArray.filter(
                                            (option) =>
                                                option.value ==
...
export default connect(mapToStateProps, mapDispatchToProps)(PayoutList)
