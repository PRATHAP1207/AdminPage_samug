...
export default function Chart2Comparision() {
  const user = JSON.parse(localStorage.getItem('storageTableListData'));
  const userData = useSelector((state) => state.usertree)
 //console.log("jsongraphhhh",userData.graphApidata)
// console.log("jsongraphhhh",user.data.splitData)
  ...
  userData.graphApidata.forEach(a => {
    if (a.countryId == 101) {
